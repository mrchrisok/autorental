...
namespace AutoRental.Admin.Tests
{
    ...
    public class MaintainCarsViewModelTests
    {
        ...
        {
            Car car = new Car() { CarId = 1, Color = "White", Year = 2013, RentalPrice = 100, Description = "Dodge Torino"};
            ...
            Assert.IsTrue(viewModel.CurrentCarViewModel != null && viewModel.CurrentCarViewModel.Car.CarId == 1);
        ...
        public void TestAddCarCommand()
        {
            ...
            viewModel.AddCarCommand.Execute(null);

            Assert.IsTrue(viewModel.CurrentCarViewModel != null);
            Assert.IsTrue(viewModel.CurrentCarViewModel.Car.CarId == 0);
        }
    }
}
